...
[View the live project here.](https://osvaldss.github.io/)
...
<h2 align="center"><img src="assets/images/mockup-screenshot-light.jpg"></h2>
...
- ### Existing Features
    ...
    - All content displayed on one page.
        - You can navigate through page sections with a navigation bar. (On mobile devices navigation bar is displayed through expandable list "Burger icon")
        - On the page right bottom side there is a button to go back to the top, displayed after the user scroll down page 400px.

    - Page divided into six sections
        - Landing page "hero image" is focused on giving the impression of what page content is about. It has a call-out text and call to action button to subscribe for the latest band news. [Hero-img](assets/testing-user-stories/page-top-section.png)
        ...
        - The Biography article gives a short summary about the band. [Bio](assets/testing-user-stories/biography.png)
...
- ### Features to Implement
    ...
    - A section/page where fans could buy bands' merchandise.
    - Add a forum/blog section to give users/fans to share their opinion about the band.
...
- ### Testing User Stories from User Experience (UX) Section
    ...
    - #### First Time Visitor Goals
        ...
        1.  As a First Time Visitor, I want to easily understand the main purpose of the site and learn more about the band. 
            1. Upon entering the site, users are automatically greeted with a navigation bar, that contains all the sections of the page.
            2. Underneath there is one of the band singers' profile pictures as a hero image that gives the user a sense of what is this web page content about. [Preview](assets/testing-user-stories/page-top-section.png)
        ...
        2. As a First Time Visitor, I want to be able to easily be able to navigate throughout the site to find content.
            ...
            2. The user has two options go through the page, first using the navigation bar using call to action button or using a scrollbar, scrolling through the page content.
    ...
    - #### Returning Visitor Goals
        ...
        1. As a Returning Visitor, I want to find more band-released songs and music videos.
            ...
            2. Page has links to media services where they can listen to all the latest songs/hits. [Media libarary](assets/testing-user-stories/latest-songs-links.png)
        ...
        3. As a Returning Visitor, I want to find the best way to contact representatives of the band to answer my other queries.
            1. Navigation bar has a menu list option to go to the page contacts section. [Navigation](assets/testing-user-stories/nav-bar-desk.png)
    ...
    - #### Frequent User Goals
        ...
        2. As a Frequent User, I want to check on bands upcoming music events. 
            ...
            2. Event section displays all upcoming events with followed information (Name of event, date, location, price) and a link where the user can book a ticket. [Events section](assets/testing-user-stories/events-section.png)
...
- ### Further Testing
    ...
    - Tested both forms (subscribe to newsletter/contact-us) on the page.
...
- ### Forking the GitHub Repository
    ...
    - A GitHub fork is a copy of a repository that sits in your account rather than the account from which you forked the data from. Once you have forked it, you own your forked copy. This means that you can edit the contents of your forked repository without impacting original repository.
        1. Log in to [GitHub](https://github.com/)
        2. Jst a little below you user avatar icon there is a button that frosk repository.
        3. After you click the button it will fork your repository and oyu will have a copy.
...
- ### Making a Local Clone 
    - You can clone your repository to create a local copy on your computer and sync between the two locations.
        ...
        6. Type git clone, and then paste link oyu copied from "Code" dropdown menu.
        7. Press Enter. Your local clone will be created.
        8. Upon sucesfuly craeated a your repository clone you will see following information in the terminal.
            ```
